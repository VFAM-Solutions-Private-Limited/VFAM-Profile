export default function PrivacyPolicy() {
  return (
    <div style={{padding:"40px"}}>
        ...
        <p>We use Your Personal Data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy describes our policies and procedures on the collection, use, and disclosure of your information when you use our Service.</p>
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to VFAM Solutions Private Limited, KSR Kalvi Nagar, Tiruchengode, Namakkal, Tamil Nadu, India.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to VFAM Solutions, accessible from <a href="https://vfamsolutions.com" rel="external nofollow noopener" target="_blank">https://vfamsolutions.com</a>.</p>
        </li>
        <li>
        ...
        <ul>
        <li>
        <p>By email: vfamsolutions@gmail.com</p>
        </li>
        <li>
        <p>By visiting this page on our website: <a href="https://vfamsolutions.com/#contact" rel="external nofollow noopener" target="_blank">https://vfamsolutions.com/#contact</a></p>
        </li>
        </ul>
    </div>
  );
